package com.example.yourgrocerylist.Data;
...
import com.example.yourgrocerylist.Util.Constants;
...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String CREATE_GROCERY_TABLE="CREATE TABLE "+Constants.TABLE_NAME+"("+Constants.KEY_ID+" INTEGER PRIMARY KEY,"
                +Constants.KEY_GROCERY_ITEM+" TEXT,"+Constants.KEY_QTY_NUMBER+" TEXT,"+Constants.KEY_DATE_NAME
        +" LONG)";
